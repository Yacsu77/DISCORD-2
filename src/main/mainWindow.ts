...
import { applyDiscordRegionProxy } from "./discordRegionProxy";
...
function initSettingsListeners(win: BrowserWindow) {
    ...
    addSettingsListener("discordRegionProxyEnabled", async () => {
        await applyDiscordRegionProxy();
        loadUrl(undefined);
    });
    addSettingsListener("discordRegionProxy", () => applyDiscordRegionProxy());
}
