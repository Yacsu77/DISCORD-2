...
function applyWebRTCPolicy() {
    const policy =
        Settings.store.discordRegionProxyEnabled !== false
            ? "default_public_interface_only"
            : (Settings.store.webRTCIPHandlingPolicy ?? "default");
...
Settings.addChangeListener("webRTCIPHandlingPolicy", applyWebRTCPolicy);
Settings.addChangeListener("discordRegionProxyEnabled", applyWebRTCPolicy);
